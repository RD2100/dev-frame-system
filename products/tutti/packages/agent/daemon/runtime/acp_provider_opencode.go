...
func NewOpenCodeAdapter(transport ProcessTransport) *standardACPAdapter {
	return NewOpenCodeAdapterWithHostMetadata(transport, LegacyHostMetadata(), nil)
}

func NewOpenCodeAdapterWithHostMetadata(transport ProcessTransport, host HostMetadata, commandResolver ProviderCommandResolver) *standardACPAdapter {
