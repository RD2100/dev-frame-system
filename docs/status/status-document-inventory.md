...
For release review, start with [Release Readiness](../status/release-readiness.md)
and [Reviewer Index](../status/reviewer-index.md) before reading planning
material.
...
`2725227d`, with local branch-level review PASS at `bd73d6bc`, but remains
pending PR/CI and publication evidence. Do not use that record as release
readiness evidence.
