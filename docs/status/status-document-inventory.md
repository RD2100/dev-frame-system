...
| `area-plan` | `local-agent-cluster-roadmap.md`, `cluster-coordinator-design-and-roadmap.md`, `phase-1-global-coordinator-conversation-plan.md`, `agent-cluster-unknowns-register.md`, `global-lifecycle-gsd-superpowers-assessment.md`, `design-orchestration-mcp.md`, `design-devframe-mcp-orchestrator-surface.md` |
...
| `historical-handoff` | `devframe-code-opencode-handoff.md` |
...
Handoff records are transfer material. They are valuable because they make
work transferable, but they should expire as authority after their
instructions are consumed into the execution root, stable docs, or implemented
contracts. Retired handoff records remain recoverable through Git history.
