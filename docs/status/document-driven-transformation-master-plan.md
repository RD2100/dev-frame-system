...
local branch-level review PASS at `bd73d6bc`, and still requires PR/CI and
publication evidence before release-readiness claims.
...
P3-2 is already local-review PASS, committed in `2725227d`, and locally
branch-reviewed at `bd73d6bc`, with PR/CI and publication evidence still pending
