...
- Review-governance completion status:
  - `docs/status/review-governance-kernel-completion-20260706.md` reports P3-2 graph projection as local GPT-equivalent review PASS and committed in `2725227d`; keep it out of release-ready claims until branch review, PR/CI, and publication evidence exist.
...
9. Confirm P3-2 graph projection is not treated as release-ready while branch review, PR/CI, and publication evidence are still pending.
