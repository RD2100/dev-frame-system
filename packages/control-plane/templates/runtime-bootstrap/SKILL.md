...
6. Finalizer: run `python tools/go_evidence.py finalize <run-dir> --team-runtime-dir <runtime-dir>` when a DevFrame runtime directory is available; otherwise run
   `python tools/go_evidence.py finalize <run-dir>`.
